...
public class SessionManager {
	...
	private static final String USERSEARCHON = "usersearchon";
	...
	public int getUsersearchon() {
		return pref.getInt(USERSEARCHON, 0);
	}
	
	public void setUsersearchon(int searchon) {
		editor.putInt(USERSEARCHON, searchon);
		editor.commit();
	}
